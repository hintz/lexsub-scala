...
object CreateCandidateList extends App {
  ...
  io.write("resources/germeval2015/targets.txt", targets.map(_.lemma).distinct.mkString("\n"))
  io.write("resources/germeval2015/targets-pos.txt", targets.map(t => t.lemma + "\t" + t.pos).distinct.mkString("\n"))
  ...
  io.write("resources/germeval2015/candidates/germeval_gold.tsv", goldCandidates.mkString("\n"))
}