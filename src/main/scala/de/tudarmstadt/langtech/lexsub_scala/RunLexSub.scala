...
object RunLexSub extends App {
  ...
  */
  ...
  println("Loading n-grams..")
  val web1t = Web1TLookup(web1tFolder, 5)
  //val germanWebCounts = Web1TLookup(germanWebCountsFolder, 5)
  
  println("Loading word embeddings..")
  val word2vecEmbedding = Word2VecLookup(word2vecFile)
  val eigenwordEmbedding = WordVectorFileLookup(embeddingFile)
  
  println("Loading DT lookup..")
  ...
  Training.crossvalidate(data, candidates, features, trainingDir, 10)
  System.exit(0)
